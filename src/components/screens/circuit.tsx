...
import { Circuit, Driver, Team } from '@/src/context/F1DataContext'
import { router, Stack, useLocalSearchParams } from 'expo-router'
import { layoutStyles, cardStyles } from '@/src/components/ui/Styles'
import { getCircuitDetailImage } from '@/src/constants/CircuitImages'
...
export default function CircuitDetail() {
  ...
  const circuitDetailImage = getCircuitDetailImage(circuitId, year)
